  ...
  return (
    <section className="text-gray-400 bg-gray-900 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="container mx-auto p-10 md:p-20 grid lg:grid-cols-3 2xl:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-y-10 transform duration-500">
          {galleryData.map((item, index) => (
            <div className="max-w-sm transform hover:-translate-y-1 duration-300 mx-3" key={index}>
